...
from Network_Security.entity.artifact_entity import DataValidationArtifact,ModelTrainerArtifact, ModelEvaluationArtifact
from Network_Security.entity.config_entity import ModelEvaluationConfig
